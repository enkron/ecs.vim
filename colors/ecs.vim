...
hi CursorLine ctermfg=NONE ctermbg=darkgray cterm=NONE term=NONE guifg=NONE guibg=#666666
hi CursorLineNr ctermfg=black ctermbg=darkgray cterm=bold term=bold guifg=#000000 guibg=#666666
hi Directory ctermfg=blue guifg=#0000ff guibg=NONE
...
hi MatchParen ctermfg=darkcyan ctermbg=black cterm=bold term=bold guifg=#339999 guibg=#000000
...
hi StatusLine ctermbg=black ctermfg=lightgray guifg=#cccccc guibg=#000000
hi User1 ctermfg=black ctermbg=lightgray cterm=NONE guifg=#000000 guibg=#cccccc
hi User2 ctermfg=darkred ctermbg=lightgray cterm=bold guifg=#990000 guibg=#cccccc
hi User3 ctermfg=black ctermbg=lightgray cterm=bold guifg=#000000 guibg=#cccccc
hi User4 ctermfg=lightgray ctermbg=black cterm=bold guifg=#cccccc guibg=#000000
hi User5 ctermfg=brown ctermbg=lightgray cterm=bold guifg=#999900 guibg=#cccccc
...
hi Constant ctermfg=blue term=bold cterm=bold guifg=#0000ff guibg=NONE
hi String ctermfg=white cterm=italic guifg=#ffffff guibg=NONE
hi Character ctermfg=brown guifg=#999900 guibg=NONE
hi Number ctermfg=brown guifg=#999900 guibg=NONE
hi Boolean ctermfg=brown cterm=bold term=bold guifg=#999900 guibg=NONE
hi Float ctermfg=brown cterm=bold term=bold guifg=#999900 guibg=NONE
...
hi Operator ctermfg=darkmagenta cterm=bold term=bold guifg=#9933ff guibg=NONE
hi Keyword ctermfg=brown guifg=#999900 guibg=NONE

hi Macro ctermfg=blue guifg=#0000ff guibg=NONE

hi PreProc ctermfg=darkblue cterm=bold guifg=#3333ff guibg=NONE
hi PreCondit ctermfg=blue guifg=#0000ff guibg=NONE
hi link Include PreProc
hi link Define PreProc

hi Type ctermfg=darkblue guifg=#3333ff guibg=NONE
hi link StorageClabluess Type
hi link Structure Type
hi link Typedef Type

hi Special ctermfg=brown cterm=bold,italic term=bold guifg=#999900 guibg=NONE
hi StorageClass ctermfg=darkmagenta cterm=bold term=bold guifg=#9933ff guibg=NONE

hi SpecialChar ctermfg=brown guifg=#999900 guibg=NONE
hi Tag ctermfg=darkblue guifg=#3333ff guibg=NONE
hi Delimeter ctermfg=brown guifg=#999900 guibg=NONE

hi SpecialKey ctermfg=brown cterm=bold term=bold guifg=#999900 guibg=NONE
